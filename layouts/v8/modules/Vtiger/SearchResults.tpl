...
{strip}
	<script type="text/javascript" src="{vresource_url('layouts/v8/modules/Vtiger/resources/List.js')}"></script>
	<script type="text/javascript" src="{vresource_url('layouts/v8/modules/Vtiger/resources/SearchList.js')}"></script>
