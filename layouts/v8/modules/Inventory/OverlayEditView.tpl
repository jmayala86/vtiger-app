...
<script type="text/javascript" src="{vresource_url('layouts/v8/modules/Inventory/resources/Edit.js')}"></script>
<script type="text/javascript" src="{vresource_url('layouts/v8/modules/'|cat:{$MODULE}|cat:'/resources/Edit.js')}"></script>
