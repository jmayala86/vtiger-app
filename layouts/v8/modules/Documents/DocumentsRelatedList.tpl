											...
											<ul class="dropdown-menu">
												...
												<li id="VtigerAction">
													<a href="javascript:Documents_Index_Js.uploadTo('Vtiger',{$PARENT_ID},'{$MODULE}')">
														<img style="  margin-top: -3px;margin-right: 4%;" title="Vtiger" alt="Vtiger" src="layouts/v8/skins//images/Vtiger.png">
    ...
    <script type="text/javascript">
        jQuery(function() {
            if(typeof Documents_Index_Js !== 'function') {
                jQuery("body").append('<script type="text/javascript" src="layouts/v8/modules/Documents/resources/Documents.js"><\/script>');
            }
        });
    </script>
{/literal}