...
<script type="text/javascript" src="{vresource_url('layouts/v8/modules/Vtiger/resources/ExtensionCommon.js')}"></script>
<script type="text/javascript" src="{vresource_url('layouts/v8/modules/Vtiger/resources/Extension.js')}"></script>
