...
function md5(str: string): string {
  // SparkMD5-free implementation using SubtleCrypto is async;
  // vtiger Mobile API accepts plain MD5. We use a small sync implementation.
  return md5Impl(str)
}

// Minimal sync MD5 — RFC 1321
